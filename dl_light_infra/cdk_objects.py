...
class Bucket():
    ...
    def cdk_construct(self, scope: Construct, read_write_access: iam.PrincipalBase = None) -> s3.Bucket:
...
class ProtectedBucket(Bucket):
    ...
    def cdk_construct(self, scope: Construct, read_write_access: iam.PrincipalBase) -> s3.Bucket:
        """
